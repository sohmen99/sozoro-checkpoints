...
CHAIN=re.compile("すしざんまい|くら寿司|スシロー|かっぱ寿司|はま寿司|魚べい|元祖寿司|金太楼|磯丸|"
 "丸亀製麺|はなまるうどん|富士そば|ゆで太郎|小諸そば|そば処めん八|日高屋|幸楽苑|一風堂|一蘭|"
 "天丼てんや|かつや|松のや|松乃家|なか卯|吉野家|すき家|(?<![一-龥])松屋|マクドナルド|ケンタッキー|"
 "まぐろ人|舎鈴|五ノ神|魚がし日本一|まんてん鮨|三崎港|銚子丸|回転寿司みさき|梅丘寿司|"
 "六厘舎|大勝軒|山岡家|野郎ラーメン|町田商店|田所商店|花月嵐|ラーメン二郎|天下一品|"
 "ゆで太郎|そじ坊|とんでん|和幸|新宿さぼてん|さぼてん",re.I)
